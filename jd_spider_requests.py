...
class JdSeckill(object):
    def __init__(self):
        ...
        self.shop_id = global_config.getRaw("config", "shop_id")
        self.key = global_config.getRaw("config", "key")
        self.seckill_num = 2
    ...
    def make_reserve(self):
        ...
        with sync_playwright() as p:
            ...
            context = browser.new_context(
                user_agent=self.default_user_agent, storage_state={"cookies": cookies}
            )
            page = context.new_page()
            page.goto(url, wait_until="domcontentloaded")
            reserve_url = page.query_selector("#btn-reservation").get_attribute("href")
            browser.close()
        self.timers.start()
        while True:
            try:
    ...
    def get_seckill_url(self):
        ...
        while True:
            ...
            if resp_json.get("url"):
                # https://divide.jd.com/user_routing?skuId=100184237046&sn=c3f4ececd8461f0e4d7267e96a91e0e0&from=pc
                router_url = "https:" + resp_json.get("url")
                # https://marathon.jd.com/captcha.html?skuId=100184237046&sn=c3f4ececd8461f0e4d7267e96a91e0e0&from=pc
    ...
    def request_seckill_checkout_page(self):
        ...
        self.session.get(
            url=url, params=payload, headers=headers, allow_redirects=False
        )
